...
typedef struct _MS_OE_REQUEST   //BOARD_LOT_IN(2000)
{
  ...
  inline void swapBytes()
  {
    /*int16_t*/ CompetitorPeriod= __bswap_16(CompetitorPeriod);
    /*int16_t*/ SolicitorPeriod = __bswap_16(SolicitorPeriod);
    /*int16_t*/ ReasonCode      = __bswap_16(ReasonCode);
    /*uint32_t*/ TokenNo        = __bswap_32(TokenNo);
    //CONTRACT_DESC contract_desc;
    /*int16_t*/ OrderType       = __bswap_16(OrderType);
    /*double*/ OrderNumber      = swapDouble(OrderNumber);
    /*int16_t*/ BookType        = __bswap_16(BookType);
    /*int16_t*/ BuySellIndicator= __bswap_16(BuySellIndicator);
    /*uint32_t*/ DisclosedVolume= __bswap_32(DisclosedVolume);
    /*uint32_t*/ DisclosedVolumeRemaining = __bswap_32(DisclosedVolumeRemaining);
    /*uint32_t*/ TotalVolumeRemaining = __bswap_32(TotalVolumeRemaining);
    /*uint32_t*/ Volume         = __bswap_32(Volume);
    /*uint32_t*/ VolumeFilledToday = __bswap_32(VolumeFilledToday);
    /*uint32_t*/ Price          = __bswap_32(Price);
    /*uint32_t*/ TriggerPrice   = __bswap_32(TriggerPrice);
    /*uint32_t*/ GoodTillDate   = __bswap_32(GoodTillDate);
    /*uint32_t*/ EntryDateTime  = __bswap_32(EntryDateTime);
    /*uint32_t*/ MinimumFill    = __bswap_32(MinimumFill);
    /*uint32_t*/ LastModified   = __bswap_32(LastModified);
    /*int16_t*/ BranchId        = __bswap_16(BranchId);
    /*uint32_t*/ TraderId       = __bswap_32(TraderId);
    /*int16_t*/ ProClientIndicator = __bswap_16(ProClientIndicator);
    /*int16_t*/ SettlementPeriod = __bswap_16(SettlementPeriod);
    /*double*/ NnfField         = swapDouble(NnfField);
    /*double*/ MktReplay        = swapDouble(MktReplay) ;
  }
}MS_OE_REQUEST;
...
typedef struct _MS_SPD_LEG_INFO2
{
  ...
  inline void swapBytes()
  {
    /*int32_t*/Token2   = __bswap_32(Token2);
    //    CONTRACT_DESC SecurityInformation3;
    /*int16_t*/OrderType2 = __bswap_16(OrderType2);
    /*int16_t*/BuySell2 = __bswap_16(BuySell2);
    /*int32_t*/DisclosedVol2 = __bswap_32(DisclosedVol2);
    /*int32_t*/DisclosedVolRemaining2 = __bswap_32(DisclosedVolRemaining2);
    /*int32_t*/TotalVolRemaining2 = __bswap_32(TotalVolRemaining2);
    /*int32_t*/Volume2  = __bswap_32(Volume2);
    /*int32_t*/VolumeFilledToday2 = __bswap_32(VolumeFilledToday2);
    /*int32_t*/Price2   = __bswap_32(Price2);
    /*int32_t*/TriggerPrice2 = __bswap_32(TriggerPrice2);
    /*int32_t*/MinFillAon2 = __bswap_32(MinFillAon2);
...
typedef struct _MS_SPD_LEG_INFO3
{
  ...
  inline void swapBytes()
  {
    /*int32_t*/Token3   = __bswap_32(Token3);
    //    CONTRACT_DESC SecurityInformation3;
    /*int16_t*/OrderType3 = __bswap_16(OrderType3);
    /*int16_t*/BuySell3 = __bswap_16(BuySell3);
    /*int32_t*/DisclosedVol3 = __bswap_32(DisclosedVol3);
    /*int32_t*/DisclosedVolRemaining3 = __bswap_32(DisclosedVolRemaining3);
    /*int32_t*/TotalVolRemaining3 = __bswap_32(TotalVolRemaining3);
    /*int32_t*/Volume3  = __bswap_32(Volume3);
    /*int32_t*/VolumeFilledToday3 = __bswap_32(VolumeFilledToday3);
    /*int32_t*/Price3   = __bswap_32(Price3);
    /*int32_t*/TriggerPrice3 = __bswap_32(TriggerPrice3);
    /*int32_t*/MinFillAon3 = __bswap_32(MinFillAon3);
    //ST_ORDER_FLAGS OrderFlags3;
    //    char OpenClose3;
    //    ADDITIONAL_ORDER_FLAGS AddtnlOrderFlags3;
    //    char GiveUpFlag3;
...
typedef struct _MS_SPD_OE_REQUEST
{
  ...
  inline void swapBytes()
  {
    /*int16_t*/CompetitorPeriod1= __bswap_16(CompetitorPeriod1);
    /*int16_t*/SolicitorPeriod1 = __bswap_16(SolicitorPeriod1);
    /*int16_t*/ReasonCode1      = __bswap_16(ReasonCode1);
    /*int32_t*/Token1           = __bswap_32(Token1);
    //CONTRACT_DESC SecurityInformation1;
    /*int16_t*/OrderType1       = __bswap_16(OrderType1);
    /*double*/OrderNUmber1      = swapDouble(OrderNUmber1);
    /*int16_t*/BookType1        = __bswap_16(BookType1);
    /*int16_t*/BuySell1         = __bswap_16(BuySell1);
    /*int32_t*/DisclosedVol1    = __bswap_32(DisclosedVol1);
    /*int32_t*/DisclosedVolRemaining1= __bswap_32(DisclosedVolRemaining1);
    /*int32_t*/TotalVolRemaining1  = __bswap_32(TotalVolRemaining1);
    /*int32_t*/Volume1          = __bswap_32(Volume1);
    /*int32_t*/VolumeFilledToday1  = __bswap_32(VolumeFilledToday1);
    /*int32_t*/Price1           = __bswap_32(Price1);
    /*int32_t*/TriggerPrice1    = __bswap_32(TriggerPrice1);
    /*int32_t*/GoodTillDate1    = __bswap_32(GoodTillDate1);
    /*int32_t*/EntryDateTime1   = __bswap_32(EntryDateTime1);
    /*int32_t*/MinFillAon1      = __bswap_32(MinFillAon1);
    /*int32_t*/LastModified1    = __bswap_32(LastModified1);
    //ST_ORDER_FLAGS OrderFlags1;
    /*int16_t*/BranchId1        = __bswap_16(BranchId1);
    /*uint32_t*/TraderId1       = __bswap_32(TraderId1);
    /*int16_t*/ProClient1       = __bswap_16(ProClient1);
    /*int16_t*/SettlementPeriod1   = __bswap_16(SettlementPeriod1);
    //ADDITIONAL_ORDER_FLAGS AddtnlOrderFlags1;
    /*double*/NnfField          = swapDouble(NnfField);
    /*double*/MktReplay         = swapDouble(MktReplay);
    /*int32_t*/PriceDiff        = __bswap_32(PriceDiff);
    leg2.swapBytes();
    leg3.swapBytes();
  }
} MS_SPD_OE_REQUEST;
...
struct MS_OE_REQUEST_TR
{
  ...
  MS_OE_REQUEST_TR(int32_t _UserID, std::string _TMID, int16_t _BranchId, bool _COL, int16_t _STPC)
  {
...
struct MS_OM_REQUEST_TR
{
  ...
  MS_OM_REQUEST_TR(int32_t _UserID, std::string _TMID, int16_t _BranchId, bool _COL)
  {
    memset(&tap_hdr.sLength, ' ', sizeof(MS_OM_REQUEST_TR));
    memcpy(Settlor, _TMID.c_str(), _TMID.length());
    memcpy(BrokerId, _TMID.c_str(), _TMID.length());
    ...
    OrderFlags.MF               = 0;
    ProClientIndicator          = __bswap_16(1); //1:Client 2:Pro	
    tap_hdr.sLength             = __bswap_16(sizeof(MS_OM_REQUEST_TR));
  }
...
struct MS_OE_RESPONSE_SL //BOARD_LOT_IN(2000)
{
  TAP_HEADER tap_hdr;
  MESSAGE_HEADER msg_hdr;
  char ParticipantType;
...
struct MS_OE_RESPONSE_TR
{
  ...
  /*inline void Initialize(char* pchData)
  {
    ...
    TransactionCode  = __bswap_16(TransactionCode);
    ErrorCode      = __bswap_16(ErrorCode);
    OrderNumber      = __bswap_64(OrderNumber);
    LastModified    = __bswap_32(LastModified);
  }*/
  inline void swapBytes()
  {
  ...
  /*inline void getData(const OrderMsg &ordMsg)
    {
        TransactionCode = ordMsg.msgHdr.actionCode;
        LogTime         = ordMsg.msgHdr.logTime;
        ErrorCode       = ordMsg.msgHdr.errorCode;
        LogTime         = ordMsg.msgHdr.logTime;
        //ReasonCode    =
        OrderNumber     = ordMsg.orderNumber;
        Price           = ordMsg.price;
        Volume          = ordMsg.quantity
    }*/
};
