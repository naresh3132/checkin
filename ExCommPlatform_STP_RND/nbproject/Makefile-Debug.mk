...
# CC Compiler Flags
CCFLAGS=-m64 -Wall -ggdb
CXXFLAGS=-m64 -Wall -ggdb
...
${OBJECTDIR}/ConfigReader.o: ConfigReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigReader.o ConfigReader.cpp

${OBJECTDIR}/ExComm.o: ExComm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExComm.o ExComm.cpp
...
${OBJECTDIR}/md5.o: md5.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/md5.o md5.cpp
